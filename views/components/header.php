    ...
    <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            <a href="/" class="d-flex align-items-center mb-2 mb-lg-0 text-white text-decoration-none logo">
                <h5 class="m-0">Тех <span class="badge bg-warning warn__badge">Заявка</span></h5>
            </a>
            ...
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                ...
                <li id="curator">
                    <a href="/curator" class="nav-link px-2 text-white d-flex align-items-center column-gap-2">
                ...
                <li id="executor">
                    <a href="/executor" class="nav-link px-2 text-white d-flex align-items-center column-gap-2">
